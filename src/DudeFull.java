...
public class DudeFull extends Dude {
    ...
    public void transform(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        Entity dude = new DudeNotFull(this.getId(), this.getPosition(), this.getImages(), this.getImageIndex(), this.getActionPeriod(), this.getAnimationPeriod(), this.getResourceLimit());
